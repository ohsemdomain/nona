				...
				<form onSubmit={handleSubmit} className="space-y-4">
					...
					>
						<textarea
							...
							disabled={isPending}
							rows={3}
							className="w-full rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm placeholder:text-zinc-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 disabled:bg-zinc-50 disabled:text-zinc-500 dark:border-zinc-600 dark:bg-zinc-800 dark:placeholder:text-zinc-500 dark:focus:border-blue-400 dark:focus:ring-blue-400 dark:disabled:bg-zinc-900"
						/>
					</FormField>
